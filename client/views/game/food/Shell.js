...
// import IconShell from '@material-ui/icons/Fingerprint';
...
export const Shell = withStyles(styles)(({classes, className, canStart, startInteraction}) => (
  <IconShell className={cn(classes.Food, className, {canStart})}
...
export const InteractiveShell = compose(
  connect(state => {
